...
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"id", env.autoesc), env.autoesc);
output += "\"></div>\n\n        </div>\n\n    </div>\n\n\n    <div class=\"row-fluid base player_actions\" style=\"\">\n\n        <div class=\"span6 actions\">\n\n            <ul class=\"unstyled\">\n                <li>\n                    <!--\n                    <a href=\"#\" data-action=\"stop\" class=\"visible-while-playing\">\n                        <i class=\" icon-stop icon-large\" style=\"color: #0b0\"></i>\n                    </a>\n                    -->\n                    <a href=\"/en/api/v1/release/18/#1#replace\" data-action=\"play__\" class=\"hidden-while-playing__ playable popup\">\n                        <i class=\" icon-play icon-large\"></i>\n                    </a>\n                    <!--\n                    <a href=\"#\" data-action=\"pause\" class=\"\">\n                        <i class=\" icon-pause icon-large\"></i>\n                    </a>\n                    -->\n                </li>\n            </ul>\n            <!--\n\t\t\t<span>";
output += runtime.suppressValue(env.getFilter("ms2time").call(context, runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "object")),"duration", env.autoesc)), env.autoesc);
output += "</span>\n\t\t\t-->\n        </div>\n\n\n        <div class=\"span6 actions pull-right\">\n\n            <ul class=\"unstyled\">\n                <li>\n                    <a href=\"#\" data-action=\"collect\" class=\" pull-right\">\n                        <i class=\"icon-plus icon-large\"></i>\n                    </a>\n                    <!--\n                    <a href=\"#\" data-action=\"delete\" class=\" pull-right\">\n                        <i class=\"icon-trash icon-large\"></i>\n                    </a>\n                    -->\n                </li>\n            </ul>\n\n        </div>\n\n    </div>\n\n\n</div>";
return output;
} catch (e) {
  runtime.handleError(e, lineno, colno);
}
...
frame.set("item", t_3);
output += "\n\t<li>";
output += runtime.suppressValue(env.getFilter("truncate_chars_inner").call(context, runtime.memberLookup((runtime.memberLookup((runtime.memberLookup((t_3),"item", env.autoesc)),"content_object", env.autoesc)),"name", env.autoesc),30), env.autoesc);
output += "</li>\n\t";
}
}frame = frame.pop();
output += "\n\t</ul>\n\t-->\n</div>\n";
